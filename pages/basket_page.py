...
class BasketPage(BasePage):
    def should_not_be_products_in_basket(self):
        ...
        "Товары имеются в корзины, но корзина должна быть пустая, but should not be"
    ...
    def should_be_empty_basket_text(self):
        ...
        and empty_basket_text == "Ваша корзина пуста Продолжить покупки", \
        "Текст 'Ваша корзина пуста Продолжить покупки' отсутствует, но должен отображаться"